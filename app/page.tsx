...
`
      ...
      try {
        ...
        talent = `算命学の「${data.bazi.weapon}」を持つあなたには、物事の本質を見抜く鋭さがあります。${data.sukuyo}の影響もあり、既存のやり方にとらわれず新しい道を切り開く力を秘めています。あなたが最も輝くのは、自分の感性を信じて行動できる環境です。`
      }
...
・算命学: 日干[${data1.bazi.stem}] / 中心星[${data1.bazi.weapon}]
...
・算命学: 日干[${data2.bazi.stem}] / 中心星[${data2.bazi.weapon}]
...
・算命学: ${score.bazi.score}点 - ${score.bazi.detail}
...
`
      ...
      try {
        ...
        story.caution = `算命学では${score.bazi.detail}。この組み合わせでは、お互いの「当たり前」が少し違うことがあるかもしれません。でもそれは、視野を広げるチャンスでもあるのです。`
          ...
          <div className="compat-score-section">
            ...
            <div className="compat-score-bars">
              {[
                ...
                { label: '算命学', score: compatResult.score.bazi.score },
          ...
          <div className="compat-data-compare">
            ...
            <div className="compat-compare-grid">
              {[
                ...
                { label: '日干', v1: compatResult.data1.bazi.stem, v2: compatResult.data2.bazi.stem },
